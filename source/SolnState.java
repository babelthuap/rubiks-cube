/**
 *  THIS IS JUST A COPY OF CubeState FOR USE IN SolveCube
 *  (THIS SEEMS TO AVERT A BUG WHICH WE DON'T UNDERSTAND)
 *  
 * 
 *  Alec and Nicholas
 */
public class SolnState {
    // arrays to hold the positions and orientations of the cubies
    private String[] pos;
    private int[] ort;

    public SolnState( String[] inputPos, int[] inputOrt ) {
